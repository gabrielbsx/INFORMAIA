...
declare module '@ioc:Adonis/Addons/Auth' {
  ...
  */
  interface ProvidersList {
    ...
    */
    ...
    client: {
      implementation: LucidProviderContract<typeof clients>,
      config: LucidProviderConfig<typeof clients>,
    },
  }
  ...
  */
  interface GuardsList {
    ...
    */
    administrator: {
      implementation: SessionGuardContract<'user', 'administrator'>,
      config: SessionGuardConfig<'user'>,
    },
    client: {
      implementation: SessionGuardContract<'client', 'client'>,
      config: SessionGuardConfig<'client'>,
    },
  }
}
